    ...
    for epoch in tqdm(range(epoch)):
        ...
        if ver_inte_acc > best_inte_acc:
            ...
            torch.save(encoder_model.state_dict(),
                       result_save_path + 'bert_dropout_score_weigt_encoder_model_parameter_bata12.pkl')
...
def main():
    ...
    encoder_model.load_state_dict(
        torch.load(encoder_result_save_path + 'bert_dropout_score_weigt_encoder_model_parameter_bata12.pkl',
                   map_location=torch.device('cpu')))
    print("开始测试————————————————————————————————")
    # 测试结果

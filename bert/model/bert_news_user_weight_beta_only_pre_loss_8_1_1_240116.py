...
def main():
    ...
    filename = 'bert_news_user_weight_beta_only_pre_loss_8_1_1_240116.py'  # 当前路径
    ...
    encoder_result_save_path = r'../results/bert_news_user_weight_beta/only_pre_loss/round1_240116/'
